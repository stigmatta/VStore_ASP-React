...
module.exports = {
  content: ["./src/**/*.{js,jsx,ts,tsx}", extract],
  ...
  theme: {
    ...
    screens: {
      ...
      xxl: "112rem", //Biggest screen(rare to use) (1800px)
    },
    extend: {
      backgroundImage: {
        // Gradients
        ...
        "header-gradient":
          "linear-gradient(90deg, rgba(55,60,67,1) 35%, rgba(37,40,45,1) 80%)",
        "footer-gradient":
          "linear-gradient(90deg, rgba(123, 199, 77, 0.2) 0%, rgba(0, 0, 0, 0.1) 50%, rgba(122, 199, 77, 0.2) 100%)",
        "form-gradient":
          "linear-gradient(180deg, rgba(43,47,53,1) 58%, rgba(37,40,45,1) 100%)",
      },
      fontFamily: {
        // it`s used by default for body
