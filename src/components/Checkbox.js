...
export default function Checkbox({mt="2rem"}) {
    ...
    <div style={{
        ...
        <label htmlFor="link-checkbox" className="ms-2 text-md font-medium text-gray-900 dark:text-gray-300">I am 13 years of age or older and agree to the terms of the Steam Subscriber Agreement and the Valve Privacy Policy.</label>
    </div>)
}
