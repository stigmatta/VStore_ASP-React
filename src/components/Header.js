import VLogo from '../images/logo.png';
  ...
  return (
    <header className="flex h-[3.9375rem] bg-header-gradient pl-[1.5625rem] pr-[1.125em] items-center">
      ...
      <div className='flex gap-4 ml-auto items-center'>
        ...
        <Link to = "/Wishlist">
          <svg className='hoverSvg' width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Link to = "/Cart">
          <svg className='hoverSvg' width="18" height="21" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
