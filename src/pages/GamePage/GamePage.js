...
const strAndColor = {
  "Overwhelmingly Positive": "green",
  "Very Positive": "green",
  "Mostly Positive": "green",
  Mixed: "yellow",
  "Mostly Negative": "red",
  "Overwhelmingly Negative": "red",
  Neutral: "gray-lightInput",
};
        ...
        <div name="second-col" className="flex flex-col min-w-[400px]">
          ...
          <div className="flex flex-col gap-4 mt-6">
            <div className="flex justify-between">
              ...
              <span className={`text-${reviewStrColor.color}`}>
...
// function AchievementDiv({ items }) {
//   return (
//     <div className="flex flex-col gap-3">
//       <div className="flex flex-row gap-4 mt-6">
//         {items.map((item, index) => (
//           <div key={index} className="flex flex-col items-left w-[177px]">
//             <img src={item.image} alt={item.title} className="w-full h-[177px] rounded-xl" />
